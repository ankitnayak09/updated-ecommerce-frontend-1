...
<Image
    ...
    />
          ...
          <div className=" bg-gradient-to-br pb-3 pl -z-10 -mt-11 md:-mt-14 pt-9 relative rounded-t-medium rounded-bl-medium rounded-br-[100px]  from-pri-orange via-mid-orange to-pri-yellow">
