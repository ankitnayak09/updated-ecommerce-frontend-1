...
const onloadFunction=()=>{
  ...
  const beamsTokenProvider = new PusherPushNotifications.TokenProvider({
    url: "http://localhost:4000/api/v1/pusher/beams-auth",
...
/>
   ...
   <h2 className="text-2xl mx-auto max-w-2xl  lg:max-w-3xl lg:px-8 px-4 font-bold tracking-tight text-gray-900 mt-28 mb-10">What do u want...</h2>
<AllCategories/>
<HomeShopList/>
<BottomNav/>
</div>
